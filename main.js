...
client.on('ready', () => {
    client.user.setActivity('BLACK 💘 SHEWN') //Botun Durumunun Yazılacağı Yer
...
//otorol , otoisim
  ...
  client.on("guildMemberAdd", member => {
    var rol = config.kayıtsız
     ...
     member.setNickname("Varinia ⸸ Kayıtsız") //sunucuya yeni gelicek kişiye verilecek  olan ismi  
     })
